...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""  {{ $lang=='ar' ? 'lang=ar dir=rtl' : '' }}> <!--<![endif]-->
    <head>
        ...
        @if($lang=='ar')
            <link rel="stylesheet" href="{{ asset('') }}/css/main-ar.css?v={{ rand(1,99999) }}">
        @endif
...
-->
    <body>
                    ...
                    <div class="row">
                        <div class="container relative">
                            <ul id="mainnav">
                                ...
                                <li><a href="{{ $lang=="ar" ? url($lang.'/documents') : url('/documents') }}" class="resizeable-font">{{ $lang == 'ar' ? 'Documents' : 'Documents' }}</a></li>
        ...
        <div id="socialbar" class="{{ $lang=="ar" ? 'slide-in-left' : 'slide-in-right' }}">
            <a href="https://www.facebook.com/mohapuae/" target="_blank">
                <span class="fa fa-fw fa-facebook"></span>
            </a>
            <a href="https://twitter.com/mohapuae" target="_blank">
                <span class="fa fa-fw fa-twitter"></span>
            </a>
            <a href="https://www.youtube.com/user/TheMOHUAE" target="_blank">
                <span class="fa fa-fw fa-youtube"></span>
            </a>
            <a href="https://www.instagram.com/mohapuae/" target="_blank">
                <span class="fa fa-fw fa-instagram"></span>
            </a>
            <a href="https://www.linkedin.com/in/mohap-uae-%D9%88%D8%B2%D8%A7%D8%B1%D8%A9-%D8%A7%D9%84%D8%B5%D8%AD%D8%A9-%D9%88%D9%88%D9%82%D8%A7%D9%8A%D8%A9-%D8%A7%D9%84%D9%85%D8%AC%D8%AA%D9%85%D8%B9-%D8%A7%D9%84%D8%A5%D9%85%D8%A7%D8%B1%D8%A7%D8%AA%D9%8A%D8%A9-416613147/" target="_blank">
