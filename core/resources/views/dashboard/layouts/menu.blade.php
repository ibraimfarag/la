...
<div id="aside" class="app-aside modal fade folded md nav-expand">
    <div class="left navside dark dk" layout="column">
        <div class="navbar navbar-md no-radius">
            <!-- brand -->
            <img src="{{ URL::to('uploads/settings/'.Helper::GeneralSiteSettings("style_logo_" . @Helper::currentLanguage()->code)) }}" width= 150px alt="Control">
...
<i class="material-icons">&#xe7ef;</i>
                  ...
                  <span class="nav-icon">
                    ...
                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                        <a href="{{ route('faqsedit') }}">
                                <span class="nav-icon">
                                <i class="material-icons">&#xe433;</i>
                                </span>
                            <span class="nav-text">{{ __('backend.faqs') }}</span>
                        </a>
                    </li>  
                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                        <a href="{{ URL('products') }}">
                            ...
                            <span class="nav-text">{{ __('backend.addmini') }}</span>
                        </a>
                    </li>
