...
@foreach($updates_timleline as $updates_timleline)



            @if ($updates_timleline->field_value==1)


                            <div class="container clearfix mt-5 toanimate" data-animation="slide-in-left">
                                <h5 class="sub-heading mobile-center">{{ $lang=="ar" ? 'Timeline' : 'Timeline' }}</h5>
                                <br/>
                                <br/>
                                <br/>
                            </div>
                            <div class="container clearfix text-center">
                                <ul id="timeline">
                                    <li class="tip start toanimate" data-animation="slide-in-left">
                                        <span>2021</span>
                                    </li>
                                    <li class="phase toanimate" data-animation="scale-in-center-1">
                                        <span class="hex"></span>
                                        <span class="number">1.</span>
                                        <h3>SERIALISATION<br/>LEGISLATION</h3>
                                        <div class="on-active">
                                            <p>DECREE ISSUANCE</p>
                                    ...
                                    <li class="phase toanimate" data-animation="scale-in-center-2">
                                        <span class="hex"></span>
                                        <span class="number">2.</span>
                                        <h3>SOFT LAUNCH</h3>
                                        <div class="on-active">
                                            <p>10 months after issuance of
                                                the serialisation decree
                                            </p>
                                            <span class="date">April 2022</span>
                                        </div>
                                        <span class="line l2"></span>
                                    </li>
                                    <li class="phase current active toanimate" data-animation="scale-in-center-2">
                                        <span class="hex"></span>
                                        <span class="number">3.</span>
                                        <h3>ONBOARDING <br/>& TRAINING</h3>
                                        <div class="on-active">
                                            <p>To start 12 months after
                                                the issuance of the decree</p>
                                            <span class="date">June 2022</span>
                                        </div>
                                        <span class="line l3"></span>

                                        <span id="arrowIcon" class=""></span>
                                    </li>
                                    <li class="phase toanimate" data-animation="scale-in-center-3">
                                        <span class="hex"></span>
                                        <span class="number">4.</span>
                                        <h3>BUSINESS <br/>GO-LIVE</h3>
                                        <div class="on-active">
                                            <span class="date">13 December 2022</span>
                                        </div>
                                    </li>
                                    <li class="tip end toanimate" data-animation="slide-in-right">
                                        <span>2022</span>
                                    </li>
                                </ul>
                                <br/>
                                ...
                                <div id="status">
                                    <ul>
                                        <li class="tip start active toanimate" data-animation="slide-in-left"><span>2021</span></li>
                                        <li class="phase active toanimate" data-animation="scale-in-center-1"></li>
                                        <li class="phase active toanimate" data-animation="scale-in-center-2"></li>
                                        <li class="phase active current toanimate" data-animation="scale-in-center-3"></li>
                                        <li class="phase pending toanimate" data-animation="scale-in-center-4"></li>
                                        <li class="tip end toanimate" data-animation="slide-in-right"><span>2022</span></li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="container toanimate" data-animation="slide-in-right">
            <div class="row">
                <div class="col-md-12 text-left">
                    <br/>
                    <br/>
                    <h5 class="sub-heading">{{ $lang=="ar" ? 'المستجدات' : 'Updates' }}</h5>

                    <ul class="mb-5">
                        @foreach($updates as $updates)

                        <li><p class="resizeable-font">{{ $lang == 'ar' ? $updates->date_arabic. $updates->title_arabic: $updates->date_english .$updates->title_english }}


                            @if($updates->file_en==null)


                           @else
                           -
                           <a target="_blank" href="{{ asset('assets/pdfs/en/'.$updates->file_en) }}" class="resizeable-font"><i class="fa fa-fw fa-download"></i> (English)</a>
                           @endif


                           @if($updates->file_ar==null)


                           @else
                           |
                           <a target="_blank" href="{{  asset('assets/pdfs/ar/'.$updates->file_ar) }}" class="resizeable-font"><i class="fa fa-fw fa-download"></i> (Arabic)</a>
                           @endif
