...
class Contact_us extends Controller
 {
    ...
    public function index_en()
    {
        ...
        return view('contact-us',['lang'=>$lang,compact('lang')]);
    ...
    public function store_en(Request $request)
    {
        ...
        $webmail->save();
        return redirect()->route('contact_m_en')->with('status', 'Thank you for getting in touch!
    ...
    public function store_ar(Request $request)
    {
        ...
        return redirect()->route('contact_m_ar')->with('status', 'شكرا لك على تواصلك!
