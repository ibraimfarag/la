...
class HomeController extends Controller
{
    ...
    public function Home_ar()
    {
        ...
        $sectiontophoto = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="8"');
        $sectiontonumar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="9"');
        $sectiontonumen = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="25"');
        $sectiontouniten = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="26"');
        $sectiontounitar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="10"');
        $sectiontodescar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="11"');
        $sectiontodescen = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="27"');



        // section three

        $sectionthphoto = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="12"');
        $sectionthnumar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="13"');
        $sectionthnumen = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="28"');
        $sectionthuniten = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="29"');
        $sectionthunitar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="14"');
        $sectionthdescar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="15"');
        $sectionthdescen = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="30"');
        ...
        $middeldescar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="31"');
        ...
        return view('home',[
           ...
           'sectiontophoto'=>$sectiontophoto,
           'sectiontonumar'=>$sectiontonumar,
           'sectiontonumen'=>$sectiontonumen,
           'sectiontouniten'=>$sectiontouniten,
           'sectiontounitar'=>$sectiontounitar,
           'sectiontodescar'=>$sectiontodescar,
           'sectiontodescen'=>$sectiontodescen,
           'sectionthphoto'=> $sectionthphoto,
           'sectionthnumar'=>$sectionthnumar,
           'sectionthnumen'=>$sectionthnumen,
           'sectionthuniten'=>$sectionthuniten,
           'sectionthunitar'=>$sectionthunitar,
           'sectionthdescar'=>$sectionthdescar,
           'sectionthdescen'=>$sectionthdescen,
    ...
    public function Home_en()
    {
        ...
        $sectiontophoto = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="8"');
        $sectiontonum = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="25"');
        $sectiontouniten = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="26"');
        $sectiontounitar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="10"');
        $sectiontodescar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="11"');
        $sectiontodescen = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="27"');
        ...
        $sectionthphoto = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="12"');
        $sectionthnum = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="28"');
        $sectionthuniten = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="29"');
        $sectionthunitar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="14"');
        $sectionthdescar = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="15"');
        $sectionthdescen = DB::select('select * FROM   tatmeen_topic_fields   WHERE topic_id="6" and field_id="30"');
        ...
        return view('home',[
           ...
           'sectionondescen'=>$sectionondescen,
           'sectiontophoto'=>$sectiontophoto,
           'sectiontonum'=>$sectiontonum,
           'sectiontouniten'=>$sectiontouniten,
           'sectiontounitar'=>$sectiontounitar,
           'sectiontodescar'=>$sectiontodescar,
           'sectiontodescen'=>$sectiontodescen,
           'sectionthphoto'=> $sectionthphoto,
           'sectionthnum'=>$sectionthnum,
           'sectionthuniten'=>$sectionthuniten,
           'sectionthunitar'=>$sectionthunitar,
           'sectionthdescar'=>$sectionthdescar,
           'sectionthdescen'=>$sectionthdescen,
