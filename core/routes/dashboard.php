...
Route::resource('taskiy', ChangesController::class);

//Route::put('taskiy/update','ChangesController@update')->name('editpost');
//Route::post('taskiy.index')->name('delete');


Route::get('/faqs', [FaqsController::class, 'index'])->name('faqsedit');
Route::post('/faqs/add-update-faq', [FaqsController::class, 'store']);
Route::post('/faqs/edit-faq', [FaqsController::class, 'edit']);
